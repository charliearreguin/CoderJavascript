        ...
        data.forEach((gorras) => {
            ...
            <div class="row card  justify-content-center ">
              <div class="card-body w-50">
                <img src="${gorras.imagen}" class="img-fluid h-50">
                <h5 class="card-title">${gorras.nombre}</h5>
                <p class="card-text">$${gorras.precio}</p>
                <button class="btn bg-dark text-light">PROXIMAMENTE</button>
              </div>
            </div>
            `
